 ...
 * localmente no Electron). Mesmo trade-off do ElevenLabs existente.
 *
 * SECURITY: MURF_API_KEY NUNCA é concatenada em mensagens de erro,
 * bodies logados, ou chamadas `console.*`. Mensagens de erro usam apenas o
 * status HTTP + `res.text().slice(0, 200)`.
 *
