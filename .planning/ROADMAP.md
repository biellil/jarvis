...
**Plans**: 4 plans
Plans:
- [ ] 95-01-PLAN.md — STTS-01..04: Wave 0 — vendor punkt_tab PT-BR (~355KB), pin nltk dep, create test stubs (P-3 corpus gate + worker tests)
...
| 95. Streaming TTS | 0/4 | Not started | - |
