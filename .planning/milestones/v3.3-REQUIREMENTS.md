# Requirements Archive: v3.3 Python PC Control & Voice Reliability
...
- [x] **VAD-01** — Modo always-listening inicializa openwakeword com `wakeword_models=[]` (VAD-only), sem tentar carregar `alexa_v0.1.onnx` — elimina ONNXRuntimeError atual
- [x] **VAD-02** — Ring buffer pre-roll de 500ms continua funcionando corretamente após o fix
...
| REQ-ID | Phase | Status |
|--------|-------|--------|
| VAD-01 | Phase 78 | Complete |
| VAD-02 | Phase 78 | Complete |
