...
- ✓ **HMEM-01** — HybridRetriever.retrieve() combines semantic + keyword (FTS5) + recency via weighted RRF — Phase 93
- ✓ **HMEM-02** — FTS5 virtual table created idempotently with 3 auto-sync triggers + backfill on MemoryStore construction — Phase 93
- ✓ **HMEM-03** — RRF weights: semantic=0.6, keyword=0.25, recency=0.15, k=60 — Phase 93
